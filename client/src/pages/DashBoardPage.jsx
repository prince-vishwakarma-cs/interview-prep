  ...
  return (
    <DashboardLayout>
      <div className="max-w-full px-4 sm:px-6 lg:px-4 py-6">
        ...
        <button
          className=" fixed bottom-10 right-10 flex items-center text-sm font-semibold px-6 py-2.5 rounded-full bg-button-lightest text-light-button-color transition-colors hover:bg-button-lightest-hover hover:text-light-button-hover-color"
