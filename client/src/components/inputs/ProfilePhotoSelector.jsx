    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        ...
        <div className="relative">
          <img src={preview || previewUrl} alt="profile preview" className="w-20 h-20 rounded-full object-cover"/>
          <button type="button" className="h-8 w-8 flex items-center justify-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer" onClick={handleRemoveImage}>
            <LuTrash />
          </button>
        </div>
      )}
